...
@section('admin_master_content')
    ...
    <div class="card custom">
        <div class="card-header">
            ...
            <a href="{{ route('media-release.index') }}" class="btn btn-primary ms-3">
                <i class="fa fa-list me-2" aria-hidden="true"></i>
                Media Release  List
            </a>
        </div>
        <div class="card-body"> 
            {!! Form::open(['route' => 'media-release.store',  'class'=>'needs-validation','novalidate', 'id' => 'testimonial_form', 'method'=> 'post', 'files' => true]) !!}
                @csrf
