@extends('admin.reports.contact.layout')
...
@section('admin_master_content')
    ...
    <div class="card custom table-card">
        <div class="card-header">
            ...
            <a href="{{ route('contact.reports.export')}}"><button type="submit" id="dashboardExport" class="btn btn-primary" >Export</button></a>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#data-table').DataTable({
                ...
                ajax: "{{ route('reports.contact.report') }}",
                columns: [
