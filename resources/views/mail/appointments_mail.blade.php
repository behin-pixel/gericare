            ...
            <tr>
              <td style="padding: 20px; "><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                    ...
                    @if ($mailData['type']=='doctor_appointment')
                    <tr>
                        <td height="30" style="font-size: 16px; font-family:Helvetica, Arial; color: #929292; " >Doctor Name </td>
                    </tr>
                    <tr>
                        <td height="30" style="font-size: 16px; font-family:Helvetica, Arial; color: #454545; " > {{$mailData['doctor_name']}} </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="30" style="font-size: 16px; font-family:Helvetica, Arial; color: #929292; " >Appointment Date</td>
                    </tr>
                    <tr>
                        <td height="30" style="font-size: 16px; font-family:Helvetica, Arial; color: #454545; " > {{$mailData['appointment_date']}} </td>
                    </tr>
                    <tr>
                        <td height="20" style="font-size: 16px; font-family:Helvetica, Arial; color: #454545; " >&nbsp;</td>
                    </tr>
                    <tr>
                        <td height="30" style="font-size: 16px; font-family:Helvetica, Arial; color: #929292; " >Appointment Time</td>
                    </tr>
                    <tr>
                        <td height="30" style="font-size: 16px; font-family:Helvetica, Arial; color: #454545; " > {{$mailData['appointment_time']}} </td>
                    </tr>
                    <tr>
                        <td height="20" style="font-size: 16px; font-family:Helvetica, Arial; color: #454545; " >&nbsp;</td>
                    </tr>
                    ...
                    @if ($mailData['type']=='service_appointment')
                    <tr>
