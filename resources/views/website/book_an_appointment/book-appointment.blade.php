        ...
        <div class="container">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="gentric-systems">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="geric-img">
                                    <img src="{{ asset('/public/website/assets/images/icn-3.png') }}"
                                        alt="Geri Care Hospital" class="">
                                </div>
            ...
            <select class="form-control jsrequired" id="services" name="services" required>
                        ...
                        <option value="pm">PM</option>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-data cnt text-start clearfix"><input type="submit"
                                                id="submit_btn" name="submit" value="Submit"> </div>
                                    </div>
                                </div>
                            </form>
                        </div>
