...
<img src="{{ asset('/public/website/assets/images/balamurugan-b.webp') }}" alt="" class="w-100">
</div>
</div>
...
<h4><img src="{{ asset('/public/website/assets/images/location.png') }}" alt="" class=""> Locations <span> Adambakkam - All days</span></h4>
</div>
</div>
