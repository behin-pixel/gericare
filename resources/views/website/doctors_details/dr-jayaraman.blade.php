...
<img src="{{ asset('/public/website/assets/images/doctor-img-20.jpg') }}" alt="" class="w-100">
</div>
</div>
...
<h3>Dr Jayaraman<span>Pulmonologist</span></h3>
 <h4><img src="{{ asset('/public/website/assets/images/expe.png') }}" alt="" class=""> Experience <span> 31+ Years</span></h4>
<h4><img src="{{ asset('/public/website/assets/images/cap.png') }}" alt="" class=""> Education <span> MBBS, Diploma in Tuberculosis and Chest Diseases (DTCD)</span></h4>
