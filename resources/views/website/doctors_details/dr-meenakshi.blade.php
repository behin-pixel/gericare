...
<img src="{{ asset('/public/website/assets/images/doctor-img-26.jpg') }}" alt="Dr. Meenakshi - Consultant Obstetrician & Gynaecologist" class="w-100">
</div>
</div>

<div class="col-lg-7">
<div class="doc-tor-cnt">
<h1>Dr. Meenakshi<span> Consultant - Obstetrician & Gynaecologist</span></h1>
<h4><img src="{{ asset('/public/website/assets/images/expe.png') }}" alt="Geri Care Hospital" class=""> Experience <span> 17+ Years </span></h4>
<h4><img src="{{ asset('/public/website/assets/images/cap.png') }}" alt="Geri Care Hospital" class=""> Education <span> MBBS, DGO </span></h4>
