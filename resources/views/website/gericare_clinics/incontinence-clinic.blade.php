...
<div class="col-lg-12">
<h1>Incontinence Clinic (Urinary) Clinic</h1>
<ul>
...
<li> > </li>
<li class="active">Incontinence Clinic (Urinary) Clinic</li>
</ul>
</div>
...
<div class="col-lg-9">
<img src="{{ asset('/public/website/assets/images/clinic/incontinence_clinic.webp') }}" alt="Physiotherapist For Home Visits" class="w-100 mb-4">
