...
<li> > </li>
<li class="active">Sleep Disorder Clinic</li>
</ul>
</div>
...
<div class="col-lg-9">
<img src="{{ asset('/public/website/assets/images/clinic/sleep_disorder.webp') }}" alt="Physiotherapist For Home Visits" class="w-100 mb-4">
<div class="common-para">
<p class="w-100">At our Sleep Disorder Clinic, we provide comprehensive care and innovative therapies to address sleep disorders, aiming to improve sleep patterns, enhance daytime functioning, and promote optimal sleep hygiene.</p>
</div>
