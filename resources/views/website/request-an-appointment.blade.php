...
<div class="col-sm-12 col-md-6 col-lg-6">
	...
	<option value="Geri Care Hospital - T Nagar">Geri Care Hospital - T Nagar </option>
	<option value="Geri Care Hospital - Adambakkam">Geri Care Hospital - Adambakkam</option>
	<option value="Geri Care Clinics  - Adyar">Geri Care Clinics - Adyar</option>	
	<option value="Geri Care Clinics  - Anna Nagar">Geri Care Clinics  - Anna Nagar</option> 
	</select>
</div>
<div class="col-sm-12 col-md-6 col-lg-6">
...
<div class="col-sm-12 col-md-12 col-lg-12">
	<div class="form-data cnt clearfix"><input type="submit" id="submit_btn" name="submit" value="Submit"> </div>
</div>
</div>
</form>
