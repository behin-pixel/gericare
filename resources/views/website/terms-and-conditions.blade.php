...
<li><img src="{{ asset('/public/website/assets/images/hme-icn.png') }}" alt="" class="" /> Your use of any information or materials on this website is entirely at your own risk, for which we shall not be liable. It shall be your own responsibility to ensure that any products, services or information available through this website meet your specific requirements.</li>

<li><img src="{{ asset('/public/website/assets/images/hme-icn.png') }}" alt="" class="" /> This website contains material which is owned by or licensed to us. This material includes, but is not limited to, the design, layout, look, appearance and graphics. Reproduction is prohibited other than in accordance with the copyright notice, which forms part of these terms and conditions.</li>

<li><img src="{{ asset('/public/website/assets/images/hme-icn.png') }}" alt="" class="" /> All trademarks reproduced in this website, which are not the property of, or licensed to the operator, are acknowledged on the website.</li>

<li><img src="{{ asset('/public/website/assets/images/hme-icn.png') }}" alt="" class="" />Unauthorised use of this website may give rise to a claim for damages and/or be a criminal offence.</li>
